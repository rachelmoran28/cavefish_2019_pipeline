...
#usage:  ./make_picard_surface_commands.sh > picard_surface_commands.txt
...
for s in ${SAMPLES[@]}
do
    echo "java -Xmx61g -jar /panfs/roc/msisoft/picard/2.3.0/picard.jar MarkDuplicates TMP_DIR=/panfs/roc/scratch/rmoran/picard_temp/ INPUT=/home/mcgaughs/shared/Datasets/bams/surface.fish.reference.genome/v2_surfacefish_raw_bams/${s}_raw.bam OUTPUT=/home/mcgaughs/shared/Datasets/bams/surface.fish.reference.genome/v2_surfacefish_raw_bams/${s}_dupsmarked.bam METRICS_FILE=/home/mcgaughs/shared/Datasets/bams/surface.fish.reference.genome/v2_surfacefish_raw_bams/${s}_metrics.txt REMOVE_DUPLICATES="true" CREATE_INDEX="true";
    java -Xmx61g -jar /panfs/roc/msisoft/picard/2.3.0/picard.jar AddOrReplaceReadGroups TMP_DIR=TMP_DIR=/panfs/roc/scratch/rmoran/picard_temp/ INPUT=/home/mcgaughs/shared/Datasets/bams/surface.fish.reference.genome/v2_surfacefish_raw_bams/${s}_dupsmarked.bam OUTPUT=/home/mcgaughs/shared/Datasets/bams/surface.fish.reference.genome/v2_surfacefish_raw_bams/${s}_dupsmarked_rgadd.bam RGID=${s} RGLB=${s} RGPL="Illumina" RGPU=${s} RGSM=${s} CREATE_INDEX="true""
done
